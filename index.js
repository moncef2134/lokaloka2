...
client.on("message", message => {
    if (message.content.startsWith("$bcobc")) {
  ...
  client.on("message", message => {
    if (message.content === "b!help") {
     const embed = new Discord.RichEmbed() 
       ...
       $bcall | لأرسال برود كاست للكل

       $bcon  |  لأرسال برود كاست للأونلاين

       $bcinvite | لدعوة البوت الي سيرفرك
   ...
   client.on('message', message => {
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('``529268775351222283``' , `[ ${client.user.id} ]` , true)
                  .addField('``$bc``' , `[-]` , true)
...
client.on('ready', () => {
    console.log(`Logged in as ${client.user.tag} !`);
          client.user.setActivity("b!help | b!invite",{type: 'Light Server.'});
  
  });

client.login(NDgxMTEyMTA1MTI3MjQ3OTAy.DyJaNw.HN2KfM5jMevBY-zQZeY5Qpn-C9U);
